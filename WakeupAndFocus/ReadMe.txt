========================================================================
    KONSOLENANWENDUNG: WakeupAndFocus-Projektübersicht
========================================================================

Diese WakeupAndFocus-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre WakeupAndFocus-Anwendung besteht.


WakeupAndFocus.vcxproj
...
WakeupAndFocus.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen WakeupAndFocus.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
